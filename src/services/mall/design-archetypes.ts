...
export const DESIGN_ARCHETYPES: Record<string, DesignArchetype> = {
  ...
  MINIMAL_SCANDINAVIAN: {
    ...
    parent_mood: "MINIMAL_CLEAN",
    keywords: ['SCANDINAVIAN', 'NORDIC', 'HYGGE', 'COZY', 'WARM', 'WOOD', 'LAGOM', 'CASUAL', 'COMFORTABLE'],
    related_keywords: ['CLEAN', 'SIMPLE', 'NATURAL', 'PEACEFUL'],
    visual_tone: "Cozy, Simple, Casual",
  ...
  MINIMAL_FUTURISTIC: {
    ...
    parent_mood: "MINIMAL_CLEAN",
    keywords: ['FUTURISTIC', 'SF', 'SCIFI', 'WHITE-TECH', 'CLEAN-TECH', 'TOMORROW', 'SPACE', 'SPORTY'],
    related_keywords: ['MINIMAL', 'MODERN', 'ADVANCED', 'SLEEK', 'HIGH-TECH', 'ATHLETIC'],
    visual_tone: "Sleek, Advanced, Sporty",
  ...
  NEON_Y2K: {
    ...
    mood_name: "Neon Y2K",
    parent_mood: "NEON_POP",
    keywords: ['Y2K', '2000S', 'BUBBLY', 'CHROME', 'HOLOGRAPHIC', 'GLOSSY', 'MILLENNIUM', 'KITSCH', 'CUTE'],
    related_keywords: ['NEON', 'POP', 'FUN', 'NOSTALGIC', 'FUTURISTIC', 'SHINY', 'PASTEL'],
    visual_tone: "Glossy, Bubbly, Kitsch",
  ...
  ORGANIC_WELLNESS: {
    ...
    parent_mood: "ORGANIC_NATURAL",
    keywords: ['WELLNESS', 'HEALING', 'SPA', 'MINDFUL', 'MEDITATION', 'YOGA', 'HOLISTIC', 'CALM', 'PASTEL', 'ETHEREAL'],
    related_keywords: ['ORGANIC', 'NATURAL', 'ZEN', 'PEACEFUL', 'SERENE', 'SOFT'],
    visual_tone: "Healing, Calming, Ethereal",
  ...
  LUXE_EDITORIAL: {
    ...
    parent_mood: "LUXE_SOPHISTICATED",
    keywords: ['EDITORIAL', 'VOGUE', 'MAGAZINE', 'HIGH-FASHION', 'ARTISTIC', 'AVANT-GARDE', 'CHIC', 'BOLD'],
    related_keywords: ['LUXURY', 'SOPHISTICATED', 'ELEGANT', 'CREATIVE'],
    visual_tone: "Artistic, Chic, Sophisticated",
